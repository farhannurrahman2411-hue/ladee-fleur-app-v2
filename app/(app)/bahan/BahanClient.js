                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <input
                        type="text"
                        defaultValue={m.unit}
                        onBlur={(e) => updateField(m.id, 'unit', e.target.value)}
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        onBlur={(e) => updateField(m.id, 'min_stock', Number(e.target.value))}
                      ...
                      <div className="flex flex-col gap-1">
                        {Array.isArray(m.purchase_links) && m.purchase_links.length > 0 ? (
                          m.purchase_links.map((l, i) => (
                            <a key={i} href={l.url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline text-xs">{l.label || l.url}</a>
                          ))
                        ) : (
